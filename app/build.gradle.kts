...
plugins {
    ...
    id("org.springframework.boot") version "3.3.3" // minor version should be synchronized with Apache Camel version
}
...
dependencies {
    ...
    implementation("org.apache.camel.springboot:camel-undertow-starter")
